...
int modelo_administracion_espacios_crear_espacio(char *texto)
{
    ...
    char *nombres_variables[][4] = {{"nom_espacio", "string", "NOSE", ""}, {"usuario_de_negocio", "string", "NOSE", ""}, {"contraseña_de_negocio", "string", "NOSE", ""}, {NULL, NULL, NULL, NULL}};
    ...
    int ret_crear_espacio = crear_espacios((char *)obtenerValorPorOrden(&datos, 0), (char *)obtenerValorPorOrden(&datos, 1), (char *)obtenerValorPorOrden(&datos, 2), &retorno_nombre_completo_espacio);
