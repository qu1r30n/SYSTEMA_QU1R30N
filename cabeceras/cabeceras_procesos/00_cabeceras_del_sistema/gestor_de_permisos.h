...
/* Igual que checar_permiso pero sin retornar direccion de archivo; se usa cuando ya se tiene la ruta y solo se necesita validar las credenciales del negocio.
   Retorna 0 si tiene permiso, 1 si no lo tiene, -1 si ocurre un error. */
/*
 * Uso: Ejecuta checar_permiso_negocios de forma segura.
 * Entrada ejemplo: checar_permiso_negocios(nivel_minimo, ruta_archivo, id_de_espacio, usuario, contrasena, retornar_nivel)
 */
